...
public class AccountServiceTest {
  ...
  public void createAccountTest() {
    ...
    Account acc2 = new Account(102,"mouni",1200);
  ...
  public void depositTest() {
   // throw new RuntimeException("Test not implemented");
	  ...
	  assertEquals(result2, "you can't deposit 50000 at time");
}
  ...
  public void findBalanceTest() {
    //throw new RuntimeException("Test not implemented");
	  ...
	  String balanceDetails2=ac.findBalance(101);
	  String balanceDetails3=ac.findBalance(1020);
  ...
  public void withdrawnTest() {
   // throw new RuntimeException("Test not implemented");
	  ...
	  acc1.setAccno(100);
	  acc1.setAmount(100);
	  String withdraw=ac.withdrawn(acc1);
	  assertEquals(withdraw, "Withdrawn done successfully");
	  Account acc2=new Account();
	  acc2.setAccno(1000);
	  acc2.setAmount(100);
	  String withdraw1=ac.withdrawn(acc2);
	  assertEquals(withdraw1, "Invalid account humber");
	  Account acc3=new Account();
	  acc3.setAccno(100);
	  acc3.setAmount(5000);
	  String withdraw2=ac.withdrawn(acc3);
	  assertEquals(withdraw2, "You can't withdraw maintain min 500");
